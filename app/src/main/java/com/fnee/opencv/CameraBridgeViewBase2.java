...
public abstract class CameraBridgeViewBase2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static final String TAG = "CameraBridge2";
    ...
    protected int mRotation; // 0 = 0 degrees, 1=90degrees, 2=180 degrees, 3=270 degrees
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        int width = accessor.getWidth(optimalSize);
        int height = accessor.getHeight(optimalSize);
